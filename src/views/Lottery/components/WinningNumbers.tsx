...
const WinningNumbers: React.FC = () => {
  ...
  const MatchedNumber6 = useMatchingRewardLength(6)
  const MatchedNumber5 = useMatchingRewardLength(5)
    ...
    <CardWrapper>
        <CardBody>
          <StyledCardContentInner>
            ...
            <Column>
              <RowNoPadding>
                <CenteredTextWithPadding>{TranslateString(10006, 'Tickets matching 6 numbers:')}</CenteredTextWithPadding>
                <CenteredTextWithPadding>
                  <strong>{MatchedNumber6}</strong>
                </CenteredTextWithPadding>
              </RowNoPadding>
              <RowNoPadding>
                <CenteredTextWithPadding>{TranslateString(10007, 'Tickets matching 5 numbers:')}</CenteredTextWithPadding>
                <CenteredTextWithPadding>
                  <strong>{MatchedNumber5}</strong>
                </CenteredTextWithPadding>
              </RowNoPadding>
              <RowNoPadding>
              ...
              <RowNoPadding>
                <CenteredTextWithPadding>{TranslateString(10008, 'Tickets matching 1 numbers:')}</CenteredTextWithPadding>
                <CenteredTextWithPadding>
