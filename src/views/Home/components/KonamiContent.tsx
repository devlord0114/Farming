...
const KonamiContent: React.FC<KonamiProps> = ({ show }) => {
  console.log('pooh, konami content show = ', show)
  const isShow = show
    ...
    <Modal title="ROI">
      ...
      <div id="popup-container" className="popup-container image-on-top" data-sm-init="false" data-state="success">
        <div className="popup-half-column">
          ...
          <div className="button-group round vertical">
            <TwitterLink
